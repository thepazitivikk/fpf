...
def first_setup():
    ...
    while True:
        print(
            ...
            f"@username бота должен начинаться с \"thepazitivik\". {Fore.RED}(._.){Style.RESET_ALL}")
        ...
        try:
            ...
            if not username.lower().startswith("thepazitivik"):
                print(
                    f"\n{Fore.CYAN}{Style.BRIGHT}@username бота должен начинаться с \"thepazitivik\"! {Fore.RED}\(!!˚0˚)/{Style.RESET_ALL}")
                continue
